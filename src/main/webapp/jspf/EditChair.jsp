                ...
                <table class="entity-list">
                    ...
                    <c:forEach var="chair" items="${chairs}">
                        <tr>
                            ...
                            <td><a href="/EditChair?id=${fac.id}">Редактировать.</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                    ...
                    <form method="POST" action="">
                        <p>
                            <label>Наименование Кафедры
                                <input value="${editChair.getNameChair()}" type="text" name="nameChair" />
                            </label>
                        </p>
                        <p>
                            <label for>Краткое Наименование Кафедры
                                <input value="${editChair.getShortNameChair()}" type="text" name="nameShortChair" />
                            </label>
                        </p>
                        <label>Факультет
                            <select name="faculty">
                                ...
                                <c:forEach var="fac" items="${facultyNames}">
                                    <option <c:if test="${editChair.getFacultyName() == fac }">selected</c:if>>
                                            ${fac}
                                    </option>
                                </c:forEach>
                            </select>
