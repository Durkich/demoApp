...
<div id="main">
    <div class="sections">
        ...
        <section class="add-section">
            <article>
                <h3>Изменить учебный план</h3>
                <div class="text-article">
                    <form method="POST" action="">
                        <p>
                            <label >Учебный год
                                <input value="${editCurriculum.getAcademicYear()}" type="number" name="academicYear" />
                            </label>
                        </p>
                        <p>
                            <label> Направление подготовки
                                <input value="${editCurriculum.getSpeciality()}" type="text" name="Speciality" />
                            </label>
                        </p>
                        <p>
                            <label>Квалификация
                                <input value="${editCurriculum.getQualification()}" type="text" name="Quialification" />
                            </label>
                        </p>
                        <p>
                            <label>Форма обучения
                                <input value="${editCurriculum.getFormEducation()}" type="text" name="formEducation" />
                            </label>
                        </p>
                        <p>
                            <label>Имя плана
                                <input value="${editCurriculum.getNameCurriculum()}" type="text" name="NameCircullum" />
                            </label>
                        </p>
                        <p>
                            <label >Курс
                                <input value="${editCurriculum.getCourse()}" type="number" name="Course" />
                            </label>
                        </p>
                        <p>
